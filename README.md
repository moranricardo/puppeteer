...
<div style="background: #0f172a; color: #f8fafc; padding: 30px; border-radius: 15px; border: 1px solid #3b82f6; font-family: sans-serif;">
    ...
    <p style="font-style: italic; color: #94a3b8;">Gestión de recursos avanzada para entornos móviles (Termux).</p>
    ...
    <div style="display: flex; gap: 15px; margin: 20px 0; flex-wrap: wrap;">
        <div style="flex: 1; min-width: 200px; background: rgba(0,0,0,0.3); padding: 15px; border-radius: 10px; border: 1px solid #1e293b;">
            ...
            <p style="font-size: 13px; margin: 8px 0;">Uso de <code>trimcache</code> para operar en dispositivos con < 4GB RAM.</p>
        </div>
        <div style="flex: 1; min-width: 200px; background: rgba(0,0,0,0.3); padding: 15px; border-radius: 10px; border: 1px solid #1e293b;">
            <strong style="color: #4ade80;">⏱️ Módulo de Espera</strong>
            <p style="font-size: 13px; margin: 8px 0;">Algoritmo <code>Custom Wait</code> que optimiza los ciclos de CPU.</p>
        </div>
    </div>
